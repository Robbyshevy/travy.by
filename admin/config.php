<?php
// HTTP
define('HTTP_SERVER', 'http://travy.by/admin/');
define('HTTP_CATALOG', 'http://travy.by/');

// HTTPS
define('HTTPS_SERVER', 'http://travy.by/admin/');
define('HTTPS_CATALOG', 'http://travy.by/');

// DIR
define('DIR_APPLICATION', '/var/www/pdk911/data/www/travy.by/admin/');
...
define('DIR_CATALOG', '/var/www/pdk911/data/www/travy.by/catalog/');
